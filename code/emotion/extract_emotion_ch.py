...
# load negation words
negation_words = []
with open('../../resources/Chinese/others/negative/negationWords.txt', 'r', encoding='utf-8') as src:  # Updated line
    lines = src.readlines()
    for line in lines:
...
# load degree words
how_words_dict = dict()
with open('../../resources/Chinese/HowNet/intensifierWords.txt', 'r', encoding='utf-8') as src:  # Updated line
    lines = src.readlines()
    for line in lines:
...
with open('../../resources/Chinese/BosonNLP/BosonNLP_sentiment_score.txt', 'r', encoding='utf-8') as src:  # Updated line
    lines = src.readlines()
    for line in lines:
...
emoticon_df = pd.read_csv(
    '../../resources/Chinese/others/emoticon/emoticon.csv', encoding='utf-8')  # Updated line
...
# Sentimental Words
def init_words(file):
    with open(file, 'r', encoding='utf-8') as src:  # Updated line
        words = src.readlines()
